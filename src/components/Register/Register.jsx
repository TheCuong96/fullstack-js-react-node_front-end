      ...
      <div className='container py-4'>
        <div className='row g-0 align-items-center'>
          <div className='col-lg-6 mb-lg-0 mb-5'>
            ...
            >
              <div className='card-body shadow-5 p-5 text-center'>
                ...
                <form>
                  ...
                  <div className='form-outline mb-4 '>
                    <input
                      ...
                      id='form3Example3'
                      className={`${
                        validForm.validFormEmail || 'is-invalid'
                      } form-control`}
                    />
                  ...
                  <div className='form-outline mb-4'>
                    <input
                      ...
                      id='form3Example4'
                      className={`${
                        validForm.validFormPassword || 'is-invalid'
                      } form-control`}
                    />
                  ...
                  <div className='form-outline mb-4'>
                    <input
                      ...
                      id='form3Example4'
                      className={`${
                        validForm.validFormConfirmPassword || 'is-invalid'
                      } form-control`}
                    />
                    <label className='form-label' htmlFor='form3Example4'>
                      Confirm password
                  ...
                  <p className='small fw-bold mb-0 mt-2 pt-1'>
                    {`Back to login page`}
                    <a href='#!' className='link-danger' onClick={goToLogin}>
                      Login
                    </a>
                  </p>
                  {/* Register buttons */}
